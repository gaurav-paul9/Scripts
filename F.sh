#!/bin/bash
# =========================================================
#  AxionOS Dual Build Automation v12 (Final Production)
#  ✅ Full Cleanup + Custom Sync + Repo Cloning
#  ✅ Telegram Progress + PixelDrain Uploads
# =========================================================
...
_Removing old Clang prebuilts before syncing..._"
...
send_raw "✅ *All device, kernel, hardware, and vendor repos cloned successfully!*  
━━━━━━━━━━━━━━━━━━━━━━  
