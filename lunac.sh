...
rm -rf device/oneplus/astonc device/oneplus/sm8550-common kernel/oneplus/sm8550 \
...
git clone https://github.com/TheMuppets/proprietary_vendor_oneplus_astonc.git -b lineage-23.2 vendor/oneplus/astonc --depth=1
...
. build/envsetup.sh
lunch lineage_astonc-bp4a-userdebug
