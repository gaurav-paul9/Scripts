...
git clone https://github.com/crdroidandroid/android_device_oneplus_aston.git -b 16.0 device/oneplus/aston --depth=1
git clone https://github.com/crdroidandroid/android_device_oneplus_sm8550-common.git -b 16.0 device/oneplus/sm8550-common --depth=1
git clone https://github.com/crdroidandroid/android_kernel_oneplus_sm8550.git -b 16.0 kernel/oneplus/sm8550 --depth=1
git clone https://github.com/crdroidandroid/android_kernel_oneplus_sm8550-modules.git -b 16.0 kernel/oneplus/sm8550-modules --depth=1
...
git clone https://gitlab.com/crdroidandroid/proprietary_vendor_oneplus_dolby.git -b 16.0 vendor/oneplus/dolby --depth=1
...
ZIP_FILE=$(find "$OUTPUT_DIR" -type f -iname "Lunaris*.zip" -printf "%T@ %p\n" | sort -n | tail -n1 | cut -d' ' -f2-)
...
if [[ -f "$ZIP_FILE" ]]; then
  ...
  if [[ "$FILE_ID" != "null" && -n "$FILE_ID" ]]; then
    ...
    UPLOAD_MESSAGE="🎉 *Lunaris(Root) Upload Complete!*
