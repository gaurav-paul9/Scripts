...
git clone https://github.com/gaurav-paul9/android_device_oneplus_sm8550-common.git -b lineage-23.1 device/oneplus/sm8550-common --depth=1
...
lunch lineage_aston-bp3a-userdebug
m evolution
...
ZIP_FILE=$(find "$OUTPUT_DIR" -type f -iname "Evolution*.zip" -printf "%T@ %p\n" | sort -n | tail -n1 | cut -d' ' -f2-)
